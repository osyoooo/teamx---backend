...
-- Generated on 2025-08-24 09:40:02.589447
...
INSERT INTO `learning_contents` (`id`, `title`, `description`, `provider_id`, `difficulty_level`, `duration_minutes`, `points_find`, `points_shape`, `points_deliver`, `reward_amount`, `total_score`, `unlock_condition`, `required_total_score`, `prerequisite_content_id`, `status`, `created_at`) VALUES
(1, 'ゼロから始めるWebサイト制作', 'HTML/CSS基礎を学びポートフォリオ制作', 1, 2, 360, 24, 28, 8, 0, 60, '初期解放', 0, NULL, 'active', '2025-08-17 13:18:05'),
(2, 'Pythonで学ぶプログラミング基礎', '基本文法習得', 1, 2, 300, 36, 21, 12, 0, 69, '初期解放', 0, NULL, 'active', '2025-08-17 13:18:05'),
(3, 'JavaScriptで作る動くWebページ', '動的ページ制作', 6, 3, 300, 24, 28, 71, 0, 123, 'ゼロから始めるWebサイト制作クリア', 0, NULL, 'active', '2025-08-17 13:18:05');
